...
type EndpointStatus struct {
	...
	ExternalIdentifiers *EndpointIdentifiers `json:"externalIdentifiers,omitempty"`
...
/* polymorph EndpointStatus externalIdentifiers false */
	...
	if m.ExternalIdentifiers != nil {
		...
		if err := m.ExternalIdentifiers.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("externalIdentifiers")
			}
			return err
		}
	}
